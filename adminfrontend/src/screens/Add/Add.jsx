    ...
    <div className='screen'>
        ...
        <form onSubmit={onSubmitHandler} className='flex-col'>
            ...
            <div className="add-product-name flex-col">
                <p>Product name</p>
                <input value={data.name} onChange= {onChangeHandler} type="text" name="name" palceholder='Type here' />
            </div>
